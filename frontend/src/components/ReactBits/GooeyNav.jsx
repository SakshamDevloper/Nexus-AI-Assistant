...
.gooey-effect.text { color: white; transition: color 0.3s ease; }
...
.gooey-li.active { color: black !important; text-shadow: none !important; }
...
.gooey-li::after {
  ...
  opacity: 0; transform: scale(0); transition: all 0.3s ease; z-index: -1;
      ...
      `}</style>
      <div className="relative" ref={containerRef} style={colorVar}>
        <nav className="flex relative" style={{ transform: 'translate3d(0,0,0.01px)' }}>
          <ul
            ref={navRef}
            className="flex flex-col gap-1.5 list-none p-0 m-0 relative z-[3] w-full"
            style={{
              color: 'white',
          ...
          >
            {items.map((item, index) => (
              <li
                key={index}
                className={`gooey-li rounded-lg relative cursor-pointer transition-[background-color_color_box-shadow] duration-300 ease shadow-[0_0_0.5px_1.5px_transparent] text-white/60 hover:text-white ${
              ...
              >
                <a
                  ...
                  className="outline-none py-[0.6em] px-[1em] inline-flex items-center gap-2.5 w-full text-sm"
                >
